...
//                 children: [
//                   // الهيدر العلوي (الترحيب / العنوان)
//                   const HeaderWidget(),
//                   const SizedBox(height: 20),
                  
//                   // صف الإحصائيات العلوية (الطلاب، الأوراق، الاختبارات، المسودات)
//                   const StatsTopRow(),
...
//           const SizedBox(height: 40),
//           _buildMenuItem(Icons.dashboard, "لوحة التحكم", active: false),
//           _buildMenuItem(Icons.assignment, "إدارة الامتحانات", active: false),
//           _buildMenuItem(Icons.book, "المواد", active: true),
//           _buildMenuItem(Icons.check_circle, "تصحيح", active: false),
//           _buildMenuItem(Icons.rate_review, "مراجعة", active: false),
//           _buildMenuItem(Icons.settings, "إعدادات", active: false),
//         ],
//       ),
//     );
//   }
...
//         _statCard("الاختبارات المنشئة", "13", Icons.quiz, AppColors.primaryTeal.withValues(alpha: 0.7)),
//         _statCard("المسودات", "5", Icons.edit_note, AppColors.primaryTeal.withValues(alpha: 0.5)),
//       ],
//     );
//   }
...
//     width: 1.5,
//     // تم حذف dashArray لأنه غير مدعوم افتراضياً
//   ),
// ),
//       child: const Column(
