...
import 'homepage.dart'; // تأكدي من مسار شاشة البداية الخاصة بك (SmartCorrectorUI)
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        bool isTablet =
            constraints.maxWidth >= 850 && constraints.maxWidth < 1150;
        ...
        children: [
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                S.of(context).settings_subtitle,
                style: TextStyle(
  ...
  Widget _iconBtn(IconData icon, {VoidCallback? onTap}) {
    return MouseRegion(
      cursor: SystemMouseCursors
          .click, // تظهر يد الماوس عند الوقوف عليها (مهم للويب)
  ...
  Widget _buildMobileMenuBtn() => Align(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 25),
                        _buildDialogInput(
                          S.of(context).settingsCurrentPassword,
                          _oldPassController,
                          Icons.lock_outline,
                          isPass: true,
                          isObs: _obscureOld,
                        ...
                        const SizedBox(height: 15),
                        _buildDialogInput(
                          S.of(context).settingsNewPassword,
                          _newPassController,
                          Icons.lock_outline,
                          isPass: true,
                          isObs: _obscureNew,
                          ...
                          onChanged: (v) =>
                              setDialogState(() => _checkPasswordStrength(v)),
                        ),
                        // مؤشر القوة
                        ...
                        const SizedBox(height: 15),
                        _buildDialogInput(
                          S.of(context).settingsConfirmPassword,
                          _confirmPassController,
                          Icons.lock_outline,
                          isPass: true,
                          isObs: _obscureConfirm,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(S.of(context).settingsDarkMode),
              // Switch(
  ...
  Widget _buildDangerZoneCard() => Container(
    padding: const EdgeInsets.all(25),
    decoration: _cardDecoration().copyWith(color: const Color(0xFFFFEEEE)),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildInfoField(String label, String value, IconData icon) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
        label,
    ...
    children: [
      ...
      TextField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(icon, size: 20, color: const Color(0xFFCBD5E0)),
          suffixIcon: isPass
              ? IconButton(
                  icon: Icon(
  ...
  Widget _buildPrimaryBtn(String text, VoidCallback onTap) => ElevatedButton(
    onPressed: onTap,
    style: ElevatedButton.styleFrom(
  ...
  Widget _buildSecondaryBtn(String text, VoidCallback onTap) => OutlinedButton(
    onPressed: onTap,
  ...
  // Widget _buildLanguageDropdown(LocaleProvider lp) => Container(
  ...
  //     //   ],
  //     //   // onChanged: (v) => lp.updateLanguage(v!, ctrl.currentStudentId.value), // 💡 تمرير الـ ID الحالي هنا أيضاً
  //     // ),
  //   ),
  // );
